...
public class SeleniumWebDriverUtils {
    ...
    //WebElement nextRow = policyRow.findElement(By.xpath("following-sibling::tr"));
    //Actions builder = new Actions(driver);
    //    builder.moveToElement(clientPortfolioButton);
    //    builder.contextClick(clientPortfolioButton).build().perform();
//        builder.clickAndHold(clientPortfolioButton).build().perform();
